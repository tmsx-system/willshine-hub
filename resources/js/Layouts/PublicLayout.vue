...
const mobileLinks = [
    ...
    { label: 'Cart', href: '/login', key: 'cart', icon: ShoppingCart },
    { label: 'Rewards', href: '/rewards', key: 'rewards', icon: Gift },
    { label: 'Account', href: '/login', key: 'account', icon: UserRound },
];
</script>
    ...
    <div class="min-h-screen bg-[#FFF7FB] text-[#111827]">
        <div class="border-b border-[#FBCFE8] bg-[#FDF2F8] text-[#9D174D]">
            <div class="public-container flex flex-col gap-1 py-2 text-center text-xs font-bold sm:flex-row sm:items-center sm:justify-between sm:text-left">
                <p class="inline-flex items-center justify-center gap-2"><Sparkles class="h-3.5 w-3.5" /> Fresh products selected daily.</p>
        ...
        <header class="sticky top-0 z-40 border-b border-[#FBCFE8]/80 bg-white/94 shadow-[0_12px_34px_rgba(236,72,153,.08)] backdrop-blur-xl">
            <nav class="public-container flex h-[76px] items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Link href="/login" class="hidden h-12 w-12 items-center justify-center rounded-full border border-[#E5E7EB] bg-white text-[#374151] shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-[#FBCFE8] hover:bg-[#FDF2F8] hover:text-[#BE185D] hover:shadow-[0_14px_30px_rgba(236,72,153,.16)] sm:flex" aria-label="Wishlist">
                        <Heart class="h-5 w-5" />
                    </Link>
                    <Link href="/login" class="relative hidden h-12 w-12 items-center justify-center rounded-full border border-[#E5E7EB] bg-white text-[#374151] shadow-sm transition duration-200 hover:-translate-y-0.5 hover:border-[#FBCFE8] hover:bg-[#FDF2F8] hover:text-[#BE185D] hover:shadow-[0_14px_30px_rgba(236,72,153,.16)] sm:flex" aria-label="Cart">
                    ...
                    <Link href="/login" class="rounded-full bg-[#EC4899] px-6 py-3 text-sm font-black text-white shadow-[0_14px_30px_rgba(236,72,153,.28)] transition duration-200 hover:-translate-y-0.5 hover:bg-[#BE185D] hover:shadow-[0_18px_40px_rgba(190,24,93,.28)]">
                        Login
                    </Link>
                </div>
            </nav>
            ...
            <div class="public-container grid gap-10 py-12 md:grid-cols-[1.2fr_.8fr_.8fr_1fr]">
                <div>
                    ...
                    <p class="mt-4 max-w-sm text-sm leading-6 text-[#6B7280]">
                        Fresh produce and quality products for homes, retailers, restaurants, hotels, cafes, and recurring business purchases.
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="mt-4 text-sm leading-6 text-[#6B7280]">Get product updates, promos, and customer-only offers.</p>
